...
class SideBar extends React.Component<any, any> {
    ...
    getUserIsMemberTeams = (user:any) => user['partner_team_member']; //TODO: verify and implement access for member
    getUserIsOwnerTeams = (user:any) => user['partner_team_owner']; //TODO: verify and implement access for owner
